document.addEventListener('DOMContentLoaded', () => {
    ...
    selectPackageBtns.forEach(btn => {
        btn.addEventListener('click', (e) => {
            ...
            // Set the form subject
            const packageName = btn.getAttribute('data-package');
            if (subjectInput && packageName) {
                subjectInput.value = `Inquiry for ${packageName}`;
                
                // Add a small highlight effect to show it was updated
                subjectInput.style.transition = 'background-color 0.3s ease';
                subjectInput.style.backgroundColor = 'rgba(0, 166, 251, 0.1)';
                setTimeout(() => {
            ...
            if (targetSection) {
                ...
                // Focus the message input since subject is prefilled
                setTimeout(() => {
